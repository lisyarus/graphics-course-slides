...
\pause
\begin{itemize}
\item Точки: \mintinline{cpp}|GL_POINTS|
\pause
\item Линии: \mintinline{cpp}|GL_LINE_STRIP|, \mintinline{cpp}|GL_LINE_LOOP|, \mintinline{cpp}|GL_LINES|
\pause
\item Треугольники: \mintinline{cpp}|GL_TRIANGLE_STRIP|, \mintinline{cpp}|GL_TRIANGLE_FAN|, \mintinline{cpp}|GL_TRIANGLES|
\end{itemize}
\pause
...
\end{itemize}
\pause
\item Включить/выключить это поведение: \mintinline{cpp}|glEnable(GL_CULL_FACE)| или \mintinline{cpp}|glDisable(GL_CULL_FACE)| (по умолчанию \textit{выключено})
\pause
