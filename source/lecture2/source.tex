...
\pause
\item В GLSL 400 или с расширением \mintinline{glsl}|GL_ARB_gpu_shader_fp64| есть \mintinline{glsl}|double|, \mintinline{glsl}|dvec2|, ..., \mintinline{glsl}|dmat2|, ... \pause (медленные и не везде поддерживаются)
\end{itemize}
\pause
