...
\end{itemize}
\item Остальные функции OpenGL нужно динамически загружать специальными платформенными средствами
...
\item Мы будем использовать GLEW
\begin{itemize}
...
% TODO: Context & context-creation libraries
