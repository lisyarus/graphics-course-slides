...
\pause
\begin{itemize}
\item \textbf{Лекции} (слайды в \href{https://github.com/lisyarus/graphics-course-slides/tree/master/pdf}{\nolinkurl{github-репозитории}})
\pause
\item \textbf{Практики}
\pause
\begin{itemize}
\item Код-заготовка на C++ (в \href{https://github.com/lisyarus/graphics-course-practice/tree/master}{\nolinkurl{github-репозитории}})
\pause
\item Слайды с заданием (в \href{https://github.com/lisyarus/graphics-course-slides/tree/master/pdf}{\nolinkurl{github-репозитории}})
\pause
