...
\pause
\item Текущий \mintinline{cpp}|GL_ELEMENT_ARRAY_BUFFER| хранится не глобально, а {\color{red}в текущем VAO!}
\end{itemize}
\end{frame}
...
\pause
\item id текущего \mintinline{cpp}|GL_ELEMENT_ARRAY_BUFFER| хранится {\color{red}в текущем VAO!}
\pause
...
\pause
\item \mintinline{cpp}|indices| -- смещение в текущем \mintinline{cpp}|GL_ELEMENT_ARRAY_BUFFER| до места, где начинаются индексы
\end{itemize}
\end{frame}
