...
\item Чтобы сделать чёткое сглаживание, вместо значения \mintinline{glsl}|0.5| в функции \mintinline{glsl}|smoothstep| используем величину \mintinline{glsl}|length(vec2(dFdx(sdfValue), dFdy(sdfValue)))/sqrt(2.0)|
\end{itemize}
\end{frame}
