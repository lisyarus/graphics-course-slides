...
\begin{itemize}
\item Возьмите один небольшой движущийся по сцене объект (при разработке удобно взять что-то простое -- куб или сферу)
\pause
...
\item \textbf{1 балл}: есть туман
\item \textbf{3 балла}: есть объёмные тени
\end{itemize}
Всего: \textbf{15 баллов}

Защита заданий на практике \textbf{14 декабря}
\end{frame}
