...
\item Размывать тени можно прямо в результирующем шейдере, при чтении из shadow map, а можно -- в два прохода, сепарабельным фильтром
...
\item Лучше вычислять проекцию тени для направленного источника света используя видимую область камеры (чтобы ничего лишнего не попало в shadow map)
...
Защита заданий на практике \textbf{11 ноября}
\end{frame}
